// Write a function that will return only employees with salary greater than $8.00
const employees = [
    {
      "firstName": "Arabela",
      "lastName": "Fockes",
...
function employeesWithSalaryGreaterThanN(employees, n) {
  console.log(employees.filter(employee => employee.salary > n));
}
employeesWithSalaryGreaterThanN(employees, 8);