// Create a function that is receiving a collection of employees and using toString() returns a string with comma-separated `email: salary` with the following format hloyley5@uol.com.br: $1368.00, ldoige2@mashable.com: $1873.56
const employees = [
    {
      "firstName": "Arabela",
      "lastName": "Fockes",
  ...
  employees.forEach(function(employees) {
    console.log(employees.email.toString() + ": " + employees.salary.toString())
  });
